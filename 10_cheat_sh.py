...
D:\>curl cheat.sh/python/loop
#  Every occurence of "foreach" I've seen (PHP, C, ...) does basically
#  the same as pythons "for" statement.
#  
...
#  
#  What you're describing is an "array map" function. This could be done
#  with [list comprehensions][1] in python:

 names = ['tom', 'john', 'simon']

 namesCapitalized = [capitalize(n) for n in names]

  #  [1]: http://docs.python.org/3/tutorial/datastructures.htmllist-
#  comprehensions
#  
#  [Jo Are By] [so/q/18294534] [cc by-sa 3.0]
